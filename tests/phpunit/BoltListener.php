...
class BoltListener implements \PHPUnit_Framework_TestListener
{
    ...
    private function buildTestEnv()
    {
        ...
        $fs->mirror(TEST_ROOT . '/vendor/bolt/backend/app/theme_defaults/', PHPUNIT_WEBROOT . '/app/theme_defaults/', null, ['override' => true]);
        $fs->mirror(TEST_ROOT . '/vendor/bolt/backend/app/view/',           PHPUNIT_WEBROOT . '/app/view/',           null, ['override' => true]);
